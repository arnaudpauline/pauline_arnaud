class BeersController < ApplicationController
  before_action :authenticate_beer_geek!, except: [:index, :show]
  ...
  private
    ...
    def beer_params
      params.require(:beer).permit(:name, :description, :brand, :cl, :note, notes_attributes: [:value, :_destroy, :beer_geek_id, :id])
    end
end
